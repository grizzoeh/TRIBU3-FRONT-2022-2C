...
const ModalCreacionSubtarea = ({parent_task/*, tasks*/, assignees, project}) => {
    ...
    return (
        <>
            <Button size="xl" variant="primary" onClick={() => { setShow(true) }}>Crear subtarea</Button>
            <Modal dialogClassName="modalContentTarea" show={show} onHide={handleClose} >
                <Modal.Header closeButton onClick={handleClose}>
                    <Modal.Title style={{ backgroundColor: "white", color: "black" }}>Subtarea de tarea #{parent_task.id}  </Modal.Title>
                </Modal.Header>
                <Modal.Body>
...
export default ModalCreacionSubtarea;
